...
return new class extends Migration
{
    ...
    {
        Schema::create('topic_one_content_fours', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('term_five_title')->nullable();
            $table->text('term_five_content')->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('topic_one_content_fours');
    }
};
